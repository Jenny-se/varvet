...
import { KanbanCard, KanbanColumn, Supplier, InventoryItem, Priority, CardCategory } from '@/lib/types'

type CardInput = Omit<KanbanCard, 'id' | 'created_at' | 'updated_at' | 'supplier' | 'inventory'>
...
export function CardForm({ columns, suppliers, inventoryItems, initial, onSubmit, onCancel, submitting }: CardFormProps) {
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={e => set('category_tag', (e.target.value as CardCategory) || null)}
          >
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={e => set('inventory_id', e.target.value || null)}
          >
            <option value="">Ingen</option>
